local Library = loadstring(Game:HttpGet("https://raw.githubusercontent.com/keepitLowkey/Wizard-ui-Lib/main/lib.lua"))()
local PhantomForcesWindow = Library:NewWindow("Noxine")

local KillingCheats = PhantomForcesWindow:NewSection("Beta Testers")
...
KillingCheats:CreateButton("View Ball", function()
    while true do
...
KillingCheats:CreateTextbox("made by .fbii. and devv", function(text)
    print(text)
end)
